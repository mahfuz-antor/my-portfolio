    ...
    return (
        <div className="">
            ...
            <div className="col-lg-3 col-xl-3 col-md-4  text-white col-sm-12 mt-3 col-xm-12 text-center align-self-center">
                ...
                <p className="text-white">#00,Ranibazar, Rajshahi, Bangladesh</p>
            </div>
            <div className="col-lg-3 col-xl-3 col-md-4  text-white col-sm-12 mt-3 col-xm-12 text-center align-self-center">
                <h3 className=""> <FontAwesomeIcon icon={faEnvelopeOpen} size="1x" /> Email:</h3>
                <p  className="text-white">mahfuz.antor21@gmail.com</p>
            </div>
            <div className="col-lg-3 col-xl-3 col-md-4  text-white col-sm-12 mt-3 col-xm-12 text-center align-self-center">
                ...
                <a href="https://github.com/mahfuz-antor" target="-blank" className="p-2 text-white"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
            </div>
        </div>
