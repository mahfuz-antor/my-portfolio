...
const Blogs = () => {
    return (
        <div  style={{backgroundColor: '#111'}} >
            <Navbar></Navbar>
            <Header></Header>
            <h2 style={{ padding: '5px'}} className=" text-center mt-5 text-white"> My Blogs: </h2>
            ...
            <a style={{border: '3px solid rgb(6, 245, 102)', borderRadius: '10px', backgroundColor: 'white'}} className="col-md-3 m-2 p-2" href="https://antorcnjwork.medium.com/lets-learn-javascript-array-for-assign-multiple-values-in-a-variable-f144be711ea8" target="-blank">
                <div>
                    <img src={array} alt="" style={{width: '100%', borderRadius:'10px',}} />
                ...
                <div>
                    <img src={different} alt="" style={{width: '100%', borderRadius:'10px',}} />
               ...
               <div >
                    <img src={random} alt="" style={{width: '100%', borderRadius:'10px',}} />
                    <h5 className="text-justify p-2"> Ten Random concepts of JavaScript </h5>
                    <p className="text-justify">We know that JavaScript is a more powerful scripting language. It is a lightweight and dynamic language with sported object-oriented programming. Today we will learn about API, truthy and falsy value, null vs undefined, double and triple equal, scope, block scope, bind, call, apply, etc.</p>
                </div>
               </a>
            </div>
            <Footer></Footer>
